...
char opList[11] = {'+','=','-','*','/','%','<','>','!','&','|'};
char sepList[10] = {'{','}','[',']','(',')',',',';',':', '@'};
string keywords[21] = {"if", "for", "else", "return", "get", "put", "true", "false", "int", "real", "while", "do", "case", "break", "switch", "endl", "cout", "cin", "function", "boolean", "integer"};
string token = "";
string lexem = "";
int lineNumber = 1;
...
void print(string& token, string& lexem) {result << '<' << token << ">\t" << lexem << endl;}
void print(string message) {result << message << endl;};
void clearLexeme() {lexem = "";};
